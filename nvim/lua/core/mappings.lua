...
map('n', '<leader>fgf', function() require('telescope.builtin').git_files() end, 'Git files')
-- カラースキーム選択 (Leader + fc)
map('n', '<leader>fc', function() require('telescope.builtin').colorscheme() end, 'Colorschemes')
-- コマンド履歴 (Leader + fch)
map('n', '<leader>fch', function() require('telescope.builtin').command_history() end, 'Command history')
-- キーマップ検索 (Leader + fk)
map('n', '<leader>fk', function() require('telescope.builtin').keymaps() end, 'Keymaps')
